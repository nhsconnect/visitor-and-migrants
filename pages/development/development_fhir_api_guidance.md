...
To help API implementers deal with the FHIR learning curve NHS Digital has worked identified the scope of the FHIR&reg; standard that is expected to be implemented in for this API as follows: 

1. [Resource](https://www.hl7.org/fhir/DSTU2/resource.html)
	1. [Resource Identity](https://www.hl7.org/fhir/DSTU2/resource.html#id)
	2. [Business Identifiers](https://www.hl7.org/fhir/DSTU2/resource.html#identifiers)
2. [Domain Resource](https://www.hl7.org/fhir/DSTU2/domainresource.html)
	1. [Observation](http://hl7.org/fhir/DSTU2/observation.html) profiled as spine-vm-observation-1.
	2. [OperationOutcome](http://hl7.org/fhir/DSTU2/operationoutcome.html) profiled as spine-operationoutcome-1.
...
4. [Bundle](https://www.hl7.org/fhir/DSTU2/bundle.html) profiled as spine-bundle-1.
5. [Data Types](https://www.hl7.org/fhir/DSTU2/datatypes.html)
	...
	2. [Complex Types](https://www.hl7.org/fhir/DSTU2/datatypes.html#complex) 
		1. The following complex types SHALL be supported.
			...
			2. [Codeable Concept](https://www.hl7.org/fhir/DSTU2/datatypes.html#codeableconcept)
6. Interactions
	1.  Instance
		1.  [READ](https://www.hl7.org/fhir/DSTU2/http.html#read)
	2.  Type Level
		1.  [SEARCH](https://www.hl7.org/fhir/DSTU2/http.html#search)
...
{% include important.html content="This API **only** supports the `read` and `search` interactions using the HTTP `GET` request." %}
